...
<div
	bind:this={menuRef}
	class="absolute inset-e-0 top-full z-9999 mt-1 min-w-[150px] rounded-md border border-gray-300 bg-surface shadow-lg dark:border-gray-600 dark:bg-surface-dark"
>

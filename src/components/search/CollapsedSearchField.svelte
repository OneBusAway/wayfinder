...
<button
	type="button"
	{onclick}
	class="dark:bg-surface-dark/95 pointer-events-auto flex w-full items-center gap-2.5 rounded-lg border border-gray-300 bg-white/95 px-3.5 py-2.5 text-sm text-gray-500 shadow-md backdrop-blur-sm md:hidden dark:border-gray-600 dark:text-gray-400"
>
